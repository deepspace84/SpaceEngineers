...
{
    public class DSC_MissionController
    {

        public DSC_MissionController(){}


        public Dictionary<long, string> NPCPlayers = new Dictionary<long, string>();
        public Dictionary<long, DSC_Mission> Missions = new Dictionary<long, DSC_Mission>();
        ...
        public void Load()
        {
            DSC_MissionSearch test = new DSC_MissionSearch(123,123);
            Missions.Add(1, test);
